...
export default function PageLayout({ children }: { children: ReactNode }) {
  return (
    <>
      {/* Fixed Background Layer -deckt immer den ganzen Viewport ab */}
      <div className="fixed inset-0 bg-gradient-to-br from-slate-950 via-neutral-900 to-stone-950 -z-10">
